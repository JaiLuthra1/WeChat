...
def start(update, context):
    ...
    update.message.reply_text('Hi! I am Il-servitore. I can help you with your queries. Send me a message or a command. Use /help to know usage.')
...
def reply(update, context):
    ...
    answer = chatbot_response(update.message.text)
    if category(update.message.text) != 1:
        g = google_search(update.message.text, 1)
        if g != "":
